    ...
    <body class="milestone__color">
        <div class="baseDiv">
            ...
            <div class="dataFormDiv">
                ...
                <form name="passportForm" class="passportForm" id="passportForm" action="/card" method="get" accept-charset="UTF-8">
                    ...
                    <div class="northBlockDiv">
                        <div class="upLeftFormDiv">
                            ...
                            <div class="data">
                                ...
                                <div class="fieldInput">
                                    <INPUT TYPE="tel" placeholder="+7 (000) 00-00-00" name="phoneFieldBody" class="phoneFieldBody" pattern="(\+7)\([0-9]{3}\)(\s?)[0-9]{3}-?[0-9]{2}-?[0-9]{2}" maxlength="15" required>
                                </div>
                            </div>
                            ...
                            <DIV class="data">
                                ...
                                <div class="fieldInput">
                                    <select name="sexComboBox" class="sexFieldBody" required>
                                        <option value="male">Статус</option>
                                        <option value="female">Подчиненный</option>
                                        <option value="other">И т.п.</option>
                                    </select>
                                </div>
                            </DIV>
                        </div>
