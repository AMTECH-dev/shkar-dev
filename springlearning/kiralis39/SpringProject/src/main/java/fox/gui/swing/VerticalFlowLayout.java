...
public class VerticalFlowLayout implements LayoutManager, Serializable {
	 ...
	 * @see fox.gui.swing.fox.components.VerticalFlowLayout#setAlignment
	 * @since JDK1.1
	 */
	 ...
	 *         the borders of the <code>Container</code>
	 * @see fox.gui.swing.fox.components.VerticalFlowLayout#setHgap
	 * @since JDK1.1
	 */
	public int getHgap() {
		return hgap;
	 ...
	 * @param hgap the horizontal gap between components and between the components
	 *             and the borders of the <code>Container</code>
	 * @see fox.gui.swing.fox.components.VerticalFlowLayout#getHgap
	 * @since JDK1.1
	 */
	 ...
	 *         the borders of the <code>Container</code>
	 * @see fox.gui.swing.fox.components.VerticalFlowLayout#setVgap
	 * @since JDK1.1
	 */
	public int getVgap() {
		return vgap;
	 ...
	 * @param vgap the vertical gap between components and between the components
	 *             and the borders of the <code>Container</code>
	 * @see fox.gui.swing.fox.components.VerticalFlowLayout#getVgap
	 */
